...
export default function Class10() {
    ...
    const syllabus = [
        { subject: "Mathematics", topics: "Real Numbers, Polynomials, Triangles, Trigonometry, Statistics & More" },
        { subject: "Science (Physics, Chem, Bio)", topics: "Light, Electricity, Chemical Reactions, Life Processes & More" },
        { subject: "Social Science", topics: "History, Geography, Democratic Politics, Economics & More" },
        { subject: "English", topics: "Literature Reader, Grammar, Reading & Writing Skills & More" }
    ];
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            <section className="bg-white pt-48 lg:pt-56 pb-16 px-6 relative overflow-hidden">
                {/* Background curved lines matching Courses.jsx */}
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                    <div className="md:w-1/2 space-y-8">
                        <div className="inline-block bg-orange-100 text-orange-600 font-semibold px-4 py-2 rounded-full text-sm font-baloo tracking-wide">
                            🔥 Bestseller Batch
                        </div>
                        <h1 className="text-5xl md:text-6xl font-extrabold font-baloo text-black leading-tight drop-shadow-sm">
                            Class 10 <span className="text-orange-500">Board Excellence</span> Batch
                        </h1>
                        <p className="text-xl text-gray-700 max-w-lg leading-relaxed">
                            Score 95%+ in your board exams and build a rock-solid foundation for IIT-JEE/NEET with our comprehensive curriculum.
                        </p>
                        ...
                        <div className="flex items-center gap-8 pt-6 text-base font-semibold text-gray-800 font-baloo">
                            ...
                            <div className="flex items-center gap-2">
                                <CheckCircle className="w-6 h-6 text-green-500" />
                                <span>200+ Hrs Live Classes</span>
                            </div>
                        </div>
                    </div>
                    <div className="md:w-1/2 flex justify-center transform hover:scale-105 transition duration-500">
                        <img src="/images/10.png" alt="Class 10 Illustration" className="w-full max-w-lg rounded-3xl drop-shadow-2xl" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <p className="text-gray-700 text-lg">
                            We cover every subject in detail with NCERT alignment, ensuring you are fully prepared for your board exams.
                        </p>
                    ...
                    <div className="lg:w-1/2 bg-orange-50 p-10 md:p-14 rounded-[3rem] border border-orange-100 text-center relative overflow-hidden shadow-xl">
                        ...
                        <p className="text-gray-700 text-lg mb-8 relative z-10 leading-relaxed">
                            Class 10 is a crucial turning point. Our program is meticulously designed not just for board exams, but to lay an unshakeable foundation for future competitive exams like JEE, NEET, and Olympiads.
                        </p>
                        <div className="inline-block p-6 bg-white rounded-3xl shadow-lg relative z-10 transform hover:scale-105 transition">
                            <p className="font-bold text-2xl text-orange-600 font-baloo">Focus on Concept Clarity</p>
                            <p className="text-gray-500 mt-2">Say no to rote learning.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="bg-gray-900/80 backdrop-blur-xl p-10 rounded-[3rem] inline-block w-full max-w-lg border border-gray-700 shadow-2xl transform hover:-translate-y-2 transition duration-300">
                        ...
                        <div className="flex justify-center items-end gap-3 mb-8">
                            ...
                            <span className="text-gray-400 line-through text-xl font-medium mb-1">₹25,000</span>
                        </div>
