...
export default function Foundation() {
    ...
    const syllabus = [
        { subject: "Logical Reasoning", topics: "Verbal & Non-Verbal Reasoning, Puzzles, Mental Ability" },
        { subject: "Advanced Physics & Chemistry", topics: "Kinematics Basics, Atomic Structure, Mole Concept" },
        { subject: "Advanced Mathematics", topics: "Number Theory, Algebra, Basic Trigonometry & Geometry" },
        { subject: "Biology", topics: "Cell Biology, Human Physiology Basics, Genetics Intro" }
    ];
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                    <div className="md:w-1/2 space-y-8">
                        ...
                        <h1 className="text-5xl md:text-6xl font-extrabold font-baloo text-black leading-tight drop-shadow-sm">
                            Pre-Foundation Batch for <span className="text-orange-500">JEE/NEET</span>
                        </h1>
                        <p className="text-xl text-gray-700 max-w-lg leading-relaxed">
                            Build early strength for JEE/NEET with logical reasoning and core science concepts ahead of the curve.
                        </p>
                        ...
                        <div className="flex items-center gap-8 pt-6 text-base font-semibold text-gray-800 font-baloo">
                            ...
                            <div className="flex items-center gap-2">
                                <CheckCircle className="w-6 h-6 text-green-500" />
                                <span>Olympiad Focused</span>
                            </div>
                        </div>
                    </div>
                    <div className="md:w-1/2 flex justify-center transform hover:scale-105 transition duration-500">
                        <img src="/images/fd.png" alt="Foundation Illustration" className="w-full max-w-lg rounded-3xl drop-shadow-2xl" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <p className="text-gray-700 text-lg">
                            Go beyond the school curriculum. We build mental aptitude and advanced problem-solving skills.
                        </p>
                    ...
                    <div className="lg:w-1/2 bg-orange-50 p-10 md:p-14 rounded-[3rem] border border-orange-100 text-center relative overflow-hidden shadow-xl">
                        ...
                        <p className="text-gray-700 text-lg mb-8 relative z-10 leading-relaxed">
                            The smartest students don't wait for Class 11. They start early. This foundation batch bridges the gap between basic school science and the rigors of IIT/NEET preparation.
                        </p>
                        <div className="inline-block p-6 bg-white rounded-3xl shadow-lg relative z-10 transform hover:scale-105 transition">
                            <p className="font-bold text-2xl text-orange-600 font-baloo">Outsmart the Competition</p>
                            <p className="text-gray-500 mt-2">Think beyond textbooks.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="bg-gray-900/80 backdrop-blur-xl p-10 rounded-[3rem] inline-block w-full max-w-lg border border-gray-700 shadow-2xl transform hover:-translate-y-2 transition duration-300">
                        ...
                        <div className="flex justify-center items-end gap-3 mb-8">
                            <span className="text-5xl font-extrabold text-white">₹14,000</span>
                            <span className="text-gray-400 line-through text-xl font-medium mb-1">₹22,000</span>
                        </div>
