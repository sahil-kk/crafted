...
export default function Class89() {
    ...
    const syllabus = [
        { subject: "Mathematics", topics: "Algebra, Geometry, Number Systems, Mensuration & Basics" },
        { subject: "Science", topics: "Fundamentals of Physics, Chemistry, and Biology" },
        { subject: "Social Science", topics: "History, Geography, Democratic Politics, Economics" },
        { subject: "English", topics: "Literature Reader, Grammar, Reading & Writing Skills" }
    ];
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                    <div className="md:w-1/2 space-y-8">
                        ...
                        <h1 className="text-5xl md:text-6xl font-extrabold font-baloo text-black leading-tight drop-shadow-sm">
                            Class 8 & 9 <span className="text-orange-500">Strong Foundation</span> Batch
                        </h1>
                        <p className="text-xl text-gray-700 max-w-lg leading-relaxed">
                            Strengthen your basics in Maths and Science with concept clarity and interactive sessions designed for early success.
                        </p>
                    ...
                    <div className="md:w-1/2 flex justify-center transform hover:scale-105 transition duration-500">
                        <img src="/images/89.svg" alt="Class 8 and 9 Illustration" className="w-full max-w-lg rounded-3xl drop-shadow-2xl" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        ...
                        <p className="text-gray-700 text-lg">
                            Early preparation is key. We focus on building your fundamental knowledge aligned strictly with your school curriculum.
                        </p>
                    ...
                    <div className="lg:w-1/2 bg-orange-50 p-10 md:p-14 rounded-[3rem] border border-orange-100 text-center relative overflow-hidden shadow-xl">
                        ...
                        <p className="text-gray-700 text-lg mb-8 relative z-10 leading-relaxed">
                            Starting early gives you a massive advantage. We ensure learning is fun, logical, and deeply understood, completely eliminating the need for rote memorization in higher classes.
                        </p>
                        <div className="inline-block p-6 bg-white rounded-3xl shadow-lg relative z-10 transform hover:scale-105 transition">
                            <p className="font-bold text-2xl text-orange-600 font-baloo">Step-by-Step Learning</p>
                            <p className="text-gray-500 mt-2">Perfect for young minds.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="bg-gray-900/80 backdrop-blur-xl p-10 rounded-[3rem] inline-block w-full max-w-lg border border-gray-700 shadow-2xl transform hover:-translate-y-2 transition duration-300">
                        ...
                        <div className="flex justify-center items-end gap-3 mb-8">
                            <span className="text-5xl font-extrabold text-white">₹12,000</span>
                            <span className="text-gray-400 line-through text-xl font-medium mb-1">₹20,000</span>
                        </div>
                        <ul className="space-y-4 text-left mb-10 text-gray-200 text-lg">
                            ...
                            <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-orange-500" /> Regular Assessment Tests</li>
                        </ul>
