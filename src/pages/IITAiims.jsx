...
export default function IITAiims() {
    ...
    const syllabus = [
        { subject: "Advanced Physics", topics: "Mechanics, Thermodynamics, Electromagnetism, Modern Physics" },
        { subject: "Advanced Chemistry", topics: "Physical Chemistry, Organic Chemistry, Inorganic Chemistry" },
        { subject: "Advanced Mathematics", topics: "Calculus, Algebra, Coordinate Geometry, Trigonometry" },
        { subject: "Advanced Biology", topics: "Botany, Zoology, Genetics, Human Physiology" }
    ];
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                    <div className="md:w-1/2 space-y-8">
                        <div className="inline-block bg-orange-100 text-orange-600 font-semibold px-4 py-1.5 rounded-full text-sm font-baloo tracking-wide">
                            🎯 Mission All India Rank
                        </div>
                        <h1 className="text-5xl md:text-6xl font-extrabold font-baloo text-black leading-tight drop-shadow-sm">
                            IIT-JEE & AIIMS <span className="text-orange-500">Target</span> Batch
                        </h1>
                        <p className="text-xl text-gray-700 max-w-lg leading-relaxed">
                            Target top ranks with advanced-level PCM/Biology practice, mock tests, and battle-tested exam strategies.
                        </p>
                    ...
                    <div className="md:w-1/2 flex justify-center transform hover:scale-105 transition duration-500">
                        <img src="/images/iitaiims.jpg" alt="IIT AIIMS Illustration" className="w-full max-w-lg rounded-3xl drop-shadow-2xl" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2 space-y-8">
                        <h2 className="text-4xl md:text-5xl font-bold font-baloo text-black drop-shadow-sm">
                            Advanced <span className="text-orange-500">Curriculum</span>
                        </h2>
                        <p className="text-gray-700 text-lg">
                            We leave no stone unturned. Our curriculum is tailored for the toughest competitive exams in the country.
                        </p>
                    ...
                    <div className="lg:w-1/2 bg-orange-50 p-10 md:p-14 rounded-[3rem] border border-orange-100 text-center relative overflow-hidden shadow-xl">
                        ...
                        <p className="text-gray-700 text-lg mb-8 relative z-10 leading-relaxed">
                            Cracking IIT-JEE or AIIMS requires more than hard work; it requires strategy. Our expert faculty will guide you through advanced concepts, speed techniques, and pressure handling.
                        </p>
                        <div className="inline-block p-6 bg-white rounded-3xl shadow-lg relative z-10 transform hover:scale-105 transition">
                            <p className="font-bold text-2xl text-orange-600 font-baloo">Rank Acceleration Focus</p>
                            <p className="text-gray-500 mt-2">Maximum Returns on Time.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="bg-gray-900/80 backdrop-blur-xl p-10 rounded-[3rem] inline-block w-full max-w-lg border border-gray-700 shadow-2xl transform hover:-translate-y-2 transition duration-300">
                        ...
                        <div className="flex justify-center items-end gap-3 mb-8">
                            ...
                            <span className="text-gray-400 line-through text-xl font-medium mb-1">₹40,000</span>
                        </div>
                        <ul className="space-y-4 text-left mb-10 text-gray-200 text-lg">
                            <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-orange-500" /> Advanced Topics Covered</li>
                            <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-orange-500" /> 1-on-1 Mentorship & PTMs</li>
                            <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-orange-500" /> All India Test Series</li>
                        </ul>
