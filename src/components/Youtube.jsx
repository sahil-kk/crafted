export default function Youtube() {
    return (
        <section id="youtube" className="bg-white border border-red-500 py-20 px-6">
            <div
                className=" max-w-7xl mx-auto bg-slate-900 min-h-[350px] rounded-3xl p-8 md:p-16 flex flex-col md:flex-row justify-between items-center text-white shadow-sm">
