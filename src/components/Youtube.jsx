export default function Youtube() {
    return (
        <section id="youtube" className="bg-white py-6 px-6">
            <div
                className=" max-w-6xl mx-auto sm:mx-5 bg-slate-900 min-h-[350px] rounded-3xl p-8 md:p-16 flex flex-col md:flex-row md:text-2xl justify-between items-center text-white shadow-sm">
                <h2 className="text-3xl sm:text-xl md:text-3xl font-bold leading-normal mb-2 md:mb-0 text-center md:text-left">
